...
import com.example.funlearning.Question
import com.example.funlearning.R
...
class OptionAdapter(val context: Context, val question: Question) :
    ...
    override fun onBindViewHolder(holder: OptionViewHolder, position: Int) {
        ...
        if(question.userAnswer == options[position]){
            holder.itemView.setBackgroundResource(R.drawable.option1)
        }
        else{
            holder.itemView.setBackgroundResource(R.drawable.option2)
        }
